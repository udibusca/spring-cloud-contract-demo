...
public class PersonValidateContractTest {

	private RestTemplate restTemplate = new RestTemplate();

	@Test
	public void test_post_person() throws Exception {
		/*****************************************************************************************************************************************
		...
		URI personPostUrl = new URI("http://127.0.0.1:8080/person");
		String anyEmail = "abc@abc.com";
		Person person = new Person(null, UUID.randomUUID().toString(), anyEmail);
		HttpEntity<Person> request = new HttpEntity<>(person);
		ResponseEntity<String> responseEntity = restTemplate.exchange(personPostUrl, HttpMethod.POST, request, String.class);
	...
	@Test
	public void test_get_all_person() throws Exception {
		URI personGetUrl = new URI("http://127.0.0.1:8080/person");
